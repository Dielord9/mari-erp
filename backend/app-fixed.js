...
app.post('/orders', async (req, res) => {
  ...
  try {
    ...
    for (const item of items) {
      ...
      grossWeightG += (product.grossWeightG || 0) * quantity;
      netWeightG += (product.netWeightG || 0) * quantity;
      makingFeeLkr += (product.makingFeeLkr || 0) * quantity;
      wastageLkr += (product.wastageLkr || 0) * quantity;
    }

    const totalLkr = makingFeeLkr + wastageLkr;
